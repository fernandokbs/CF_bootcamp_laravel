                        ...
                        <form action="{{ route('client.store') }}" method="POST">
                            ...
                            <div>
                                ...
                                <x-text-input id="email" value="{{ old('email') }}" name="email" type="text"
                                    class="mt-2 block w-full" required autofocus autocomplete="email" />
                            </div>
                            ...
                            <div>
                                ...
                                <x-text-input id="confirmPassword" name="confirmPassword" type="password"
                                    class="mt-1 block w-full" required autofocus autocomplete="confirmPassword" />
                            </div>
                            ...
                            <select id="tratamiento" name="tratamiento"
                                ...
                                <option value="Sra." {{ old('tratamiento') == 'Sra.' ? 'selected' : '' }}>Sra.
                                </option>
                            </select>

                            <div>
                                <x-input-label class="mt-3" for="rut" :value="__('Rut')" />
                                <x-text-input id="rut" name="rut" value="{{ old('rut') }}" type="text"
                                    class="mt-1 block w-full" required autofocus autocomplete="rut" />
                            </div>
                            ...
                            <div>
                                ...
                                <x-text-input id="direccion" name="direccion" value="{{ old('direccion') }}"
                                    type="text" class="mt-1 block w-full" required autofocus
