...
<section id="subscribe" class="py-6 lg:py-24 bg-white border-t border-gray-line">
    <div class="container mx-auto">
        <div class="flex flex-col items-center rounded-lg p-4 sm:p-0 ">
            <div class="mb-8">
                <h2 class="text-center text-xl font-bold sm:text-2xl lg:text-left lg:text-3xl">Suscríbete a nuestro
                    boletín y obtén <span class="text-primary">$50 de descuento</span> en tu primer pedido.
                </h2>
            </div>
            <div class="flex flex-col items-center w-96 ">
                <form class="flex w-full gap-2">
                    ...
                    <button
                        class="bg-primary border border-primary hover:bg-transparent hover:border-primary text-white hover:text-primary font-semibold py-2 px-4 rounded-full">Suscribirse</button>
                </form>
            </div>
        </div>
    </div>
