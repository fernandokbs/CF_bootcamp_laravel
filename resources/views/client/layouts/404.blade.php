        ...
        <div class="mx-auto max-w-screen-lg px-4 md:px-8">
            <div class="grid gap-8 sm:grid-cols-2">
                ...
                <div class="flex flex-col items-center justify-center sm:items-start md:py-24 lg:py-32">
                    ...
                    <a href="/"
                        class="bg-primary hover:bg-transparent border border-transparent hover:border-primary text-white hover:text-primary font-semibold px-4 py-2 rounded-full inline-block">Go
                        back</a>
                </div>
                <!-- content - end -->
                <!-- image - start -->
